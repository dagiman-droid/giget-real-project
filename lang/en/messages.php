<?php
    ...
    return [
        ...
        "t_seller_dashboard"                                       => "Seller/Freelancer Dashboard",
        "t_become_a_seller"                                        => "Become a Seller/Freelancer",
        "t_login"                                                  => "Login",
        ...
        "t_u_became_a_seller"                                      => "Welcome! You have became a seller/freelancer",
        ...
        "t_switch_to_selling"                                      => "Switch to Selling/Freelancing",
        ...
        "t_fake_name_irman_norton"                                 => "Mohammed Ahmed",
        "t_i_am_a_designer"                                        => "I am a designer",
        "t_fake_name_alejandro_lee"                                => "Maruf Abrar",
        "t_i_am_a_developer"                                       => "I am a developer",
        "t_fake_name_elsa_king"                                    => "Abdurahman Abrar",
        "t_i_am_a_writer"                                          => "I am a full stack dev",
        "t_fake_name_herman_reese"                                 => "Yeabkal Habtamu",
        "t_i_am_a_video_editor"                                    => "I am a animator",
        "t_fake_name_sue_keller"                                   => "Adil Demelash",
        "t_i_am_a_musician"                                        => "I am a digital marketer",
        "t_buyer_stories"                                          => "Buyer stories",
        "t_buyer_story_1"                                          => "GIGET is an amazing resource for anyone in the startup space.",
        "t_buyer_story_2"                                          => "People love our logo, and we love GIGET.",
        "t_buyer_story_3"                                          => "There is no way I could have produced anything without GIGET.",
        "t_fake_name_alex_saunders"                                => "Kidus Dagne",
        "t_fake_name_ricky_jones"                                  => "Bine Berhanu",
        "t_fake_name_melissa_ross"                                 => "Dagim Wolde",
        ...
        "t_how_much_money_can_i_make_answer"                       => "It's totally up to you. You can work as much as you want. Many sellers work on GIGET full time and some keep their 9-5 job while using GIGET to make extra money.",
        "t_how_much_does_it_cost_question"                         => "How much does it cost?",
        "t_how_much_does_it_cost_answer"                           => "It's free to join GIGET. There is no subscription required or fees to list your services. You keep 80% of each withdrawal.",
        ...
        "t_how_do_i_price_my_service_answer"                       => "You can set your pricing anywhere from 10Br - 100,000Br and offer your service to buyers.",
