			...
			<div class="h-80 w-full absolute bottom-0 xl:inset-0 xl:h-full">
				<div class="h-full w-full xl:grid xl:grid-cols-2">
					<div class="h-full xl:relative xl:col-start-2">
						<img class="h-full w-full object-cover opacity-25 xl:absolute xl:inset-0 ltr:rounded-r-lg rtl:rounded-l-lg lazy" src="{{ placeholder_img() }}" data-src="{{ url('public/img/start_selling/1.webp') }}" alt="{{ __('messages.t_u_bring_the_skill_make_earn_easy') }}">
					...
					<div class="mt-12 grid grid-cols-1 gap-y-12 gap-x-6 sm:grid-cols-2">
						...
						<p>
							<span class="block text-xl font-bold text-white uppercase">
								@money(10, settings('currency')->code, true) - @money(100000, settings('currency')->code, true)
							</span>
