...
} elseif ($_instance->childHasBeenRendered('KxcpBbn')) {
    $componentId = $_instance->getRenderedChildComponentId('KxcpBbn');
    $componentTag = $_instance->getRenderedChildComponentTagName('KxcpBbn');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('KxcpBbn');
} else {
    $response = \Livewire\Livewire::mount('main.partials.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('KxcpBbn', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<script src="https://giget.da-shopping.com/wireui/assets/scripts?id=3c15fb3b36f54e2baae1e97b6eb0015e" defer ></script>
  ...
  <?php /**PATH /home/dashoppingcom/giget.da-shopping.com/resources/views/livewire/main/seller/layout/app.blade.php ENDPATH**/ ?>