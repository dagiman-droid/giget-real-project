...
} elseif ($_instance->childHasBeenRendered('0QuaZXv')) {
    $componentId = $_instance->getRenderedChildComponentId('0QuaZXv');
    $componentTag = $_instance->getRenderedChildComponentTagName('0QuaZXv');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('0QuaZXv');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('0QuaZXv', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('8xeYA83')) {
    $componentId = $_instance->getRenderedChildComponentId('8xeYA83');
    $componentTag = $_instance->getRenderedChildComponentTagName('8xeYA83');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('8xeYA83');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.sidebar');
    $html = $response->html();
    $_instance->logRenderedChild('8xeYA83', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/dashoppingcom/giget.da-shopping.com/resources/views/livewire/admin/layout/app.blade.php ENDPATH**/ ?>