...
} elseif ($_instance->childHasBeenRendered('Icy7UpR')) {
    $componentId = $_instance->getRenderedChildComponentId('Icy7UpR');
    $componentTag = $_instance->getRenderedChildComponentTagName('Icy7UpR');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Icy7UpR');
} else {
    $response = \Livewire\Livewire::mount('main.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('Icy7UpR', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('nWGo2pk')) {
    $componentId = $_instance->getRenderedChildComponentId('nWGo2pk');
    $componentTag = $_instance->getRenderedChildComponentTagName('nWGo2pk');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('nWGo2pk');
} else {
    $response = \Livewire\Livewire::mount('main.includes.footer');
    $html = $response->html();
    $_instance->logRenderedChild('nWGo2pk', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<script src="https://giget.da-shopping.com/wireui/assets/scripts?id=3c15fb3b36f54e2baae1e97b6eb0015e" defer ></script>
...
</html><?php /**PATH /home/dashoppingcom/giget.da-shopping.com/resources/views/livewire/main/layout/app.blade.php ENDPATH**/ ?>